...
Console.Write("Введите кол-во столбиков первой матрицы: ");
int n = int.Parse(Console.ReadLine() ?? "0");

Console.Write("Введите кол-во строк второй матрицы: ");
int a = int.Parse(Console.ReadLine() ?? "0");
Console.Write("Введите кол-во столбиков второй матрицы: ");
int b = int.Parse(Console.ReadLine() ?? "0");

if (n != a || m != b)
    Console.Write("Невозможно найти произведение двух матриц.Почитайте правила умножения матриц, пожалуйста.");
else
{
    ...
    if (m >= a)
        ...
        PrintArray(MatrixMult(secondArray,firstArray)); // проверка, когда написал не "как надо"
                                                        // где у первой матрицы больше столбцов, 
